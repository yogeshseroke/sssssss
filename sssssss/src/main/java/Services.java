	 ...
	 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	        ...
	        try (PrintWriter out = response.getWriter()) {
	           ...
	           out.println("<!DOCTYPE html>");
	            ...
	            out.println("<body>");
	            out.print("<header>");
	              out.print("<a href='Home'>Home</a> <a href='About'>About</a> <a href='Services'>Services</a> <a href='Gallery'>Gallery</a> <a href='Contact'>Contact Us</a>");
	            out.print("</header>");
	            
	            out.print("<section>");
	            out.print("<center><h1>Welcome in Services Page</h1></center><hr>");
